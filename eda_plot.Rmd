...
```{r audio-exp-vis}
fluidPage(
  titlePanel('Exploratory Visualations')
)
shinyaudio::audio('./audio/explore_vis.mp3')
```
...
```{r audio-setup}
shinyaudio::audio('./audio/setup.mp3')
```
...
**New packages** not used in the course  
Link to Data Tables <https://rstudio.github.io/DT/>  
Link to ShinyAudio <https://rdrr.io/github/mattkcole/shinyaudio/man/audio.html>  
